...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field places on 'Trip'
        db.create_table('core_trip_places', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('trip', models.ForeignKey(orm['core.trip'], null=False)),
            ('place', models.ForeignKey(orm['core.place'], null=False))
        ))
        db.create_unique('core_trip_places', ['trip_id', 'place_id'])


    def backwards(self, orm):
        # Removing M2M table for field places on 'Trip'
        db.delete_table('core_trip_places')
