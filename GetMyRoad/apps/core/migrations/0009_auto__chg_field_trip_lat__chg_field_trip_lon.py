...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trip.lat'
        db.alter_column('core_trip', 'lat', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=15))

        # Changing field 'Trip.lon'
        db.alter_column('core_trip', 'lon', self.gf('django.db.models.fields.DecimalField')(max_digits=50, decimal_places=15))

    def backwards(self, orm):

        # Changing field 'Trip.lat'
        db.alter_column('core_trip', 'lat', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Trip.lon'
        db.alter_column('core_trip', 'lon', self.gf('django.db.models.fields.FloatField')())
