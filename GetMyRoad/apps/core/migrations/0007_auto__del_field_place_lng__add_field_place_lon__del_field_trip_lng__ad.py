...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_place', 'lng')

        # Adding field 'Place.lon'
        db.add_column('core_place', 'lon',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)

        # Deleting field 'Trip.lng'
        db.delete_column('core_trip', 'lng')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Place.lng'
        raise RuntimeError("Cannot reverse this migration. 'Place.lng' and its values cannot be restored.")
        # Deleting field 'Place.lon'
        db.delete_column('core_place', 'lon')

        # Adding field 'Trip.lng'
        db.add_column('core_trip', 'lng',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)
