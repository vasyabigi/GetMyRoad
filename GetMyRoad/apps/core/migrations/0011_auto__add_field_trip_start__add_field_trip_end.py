...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.start'
        db.add_column('core_trip', 'start',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Trip.end'
        db.add_column('core_trip', 'end',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 30, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.start'
        db.delete_column('core_trip', 'start')

        # Deleting field 'Trip.end'
        db.delete_column('core_trip', 'end')
    ...
    models = {
        ...
        'core.trip': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'trips'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['core.Category']"}),
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 30, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.DecimalField', [], {'max_digits': '50', 'decimal_places': '15'}),
            'lon': ('django.db.models.fields.DecimalField', [], {'max_digits': '50', 'decimal_places': '15'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'places': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'trips'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['core.Place']"}),
