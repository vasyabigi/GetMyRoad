...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trip.estimated_time'
        db.add_column('core_trip', 'estimated_time',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trip.estimated_time'
        db.delete_column('core_trip', 'estimated_time')
    ...
    models = {
        ...
        'core.trip': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 1, 0, 0)'}),
            'estimated_time': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.DecimalField', [], {'max_digits': '50', 'decimal_places': '15'}),
            'lon': ('django.db.models.fields.DecimalField', [], {'max_digits': '50', 'decimal_places': '15'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
